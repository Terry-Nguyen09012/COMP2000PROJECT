...
**Student name: Terry Nguyen

**Student ID: 48915319

**GitHub repo URL:** https://github.com/Terry-Nguyen09012/COMP2000PROJECT
...
```
* 5324b3d (HEAD -> main, origin/main, origin/HEAD) Planet simulation prototype
| * 8ea7f6d (upstream/main, upstream/HEAD) Update Meteor.java
|/
* c298b07 Created main , and classes and methods
* 2b15e2b Initial commit
